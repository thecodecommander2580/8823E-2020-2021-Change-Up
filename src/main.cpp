...
void usercontrol(void) {
  ...
  LeftFrontBase.setVelocity(Controller1.Axis3.position(percent) + Controller1.Axis1.position(percent)/2, percent);
  LeftBackBase.setVelocity(Controller1.Axis3.position(percent) + Controller1.Axis1.position(percent)/2, percent);
  RightFrontBase.setVelocity(Controller1.Axis3.position(percent) - Controller1.Axis1.position(percent)/2, percent);
  RightBackBase.setVelocity(Controller1.Axis3.position(percent) - Controller1.Axis1.position(percent)/2, percent);
  ...
  if(true)
  {
    ...
    if(Optical.color() == red && Ball_Ejection_Timer == 0) { Eject_Override = true; } //Eject_Override is somewhat backwards. it being true means that the driver has full control of the Shooter.

    else if(8322327 > Optical.color() && Optical.color() < 16734192)
    {
